...
export class TicketController {
    ...
    @Get()
    async finAll(@Paginate() query: PaginateQuery): Promise<Paginated<TicketEntity>> {
    ...
    @Post()
    async post(@Body() data: TicketDto): Promise<TicketDto | {}> {
    ...
    @Put(':id')
    async put(@Param('id', ParseIntPipe) id: number, @Body() data: TicketDto): Promise<TicketDto | {}> {
